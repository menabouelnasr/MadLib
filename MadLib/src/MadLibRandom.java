...
public class MadLibRandom
{
	public static void main(String[] args)
	{
		...
		int adv  = 0 + (int)(Math.random()* adverbs.length    ); // chooses a random number thats within the range of adverbs
		...
		String adverb	=adverbs[adv]; // gets a random adverb from the array of adverbs
